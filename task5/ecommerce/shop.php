...
$viewProduct = $productObject->read();
// if ($_GET) {
//     if (isset($_GET['sub'])) {
//         if (is_numeric($_GET['sub'])) {
//             $subcategoryObject->setId($_GET['sub']);
//             $find = $subcategoryObject->find();
//             if ($find) {
                    ...
                    <div class="product-grid product-view pb-20">
                        <div class="row">
                            ...
                            if ($viewProduct) {
                                ...
                                $products = $viewProduct->fetch_all(MYSQLI_ASSOC);
                            ...
                            <ul id="faq">
                                ...
                                if ($categoryRead) {
                                    ...
                                    foreach ($categories as $categoryIndex => $category){?>
                                        <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory"><?= $category['name_en'] ?><i class="ion-ios-arrow-down"></i></a>
                                        <ul id="#shop-catigory" class="panel-collapse collapse ">
