...
class Product extends connection implements crud {
    ...
    {
        $query = "SELECT id,name_en,price,desc_en,image FROM products WHERE price  ORDER BY price DESC";
    ...
    {
        $query = "SELECT id,name_en,price,desc_en,image FROM products WHERE status = '1' 
